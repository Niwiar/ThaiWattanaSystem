...
<ModalFormBase {parent}>
	...
	<label class="flex justify-start items-center w-full">
		...
		<select bind:value={issueType} class="select w-64 rounded-md p-2">
	...
	<label for="date" class="flex justify-start items-center w-full">
		...
		<div class="flex flex-col">
			<input type="date" class="input rounded-md p-2" name="date" />
			<AlertText alerts={$page.form} field="date" />
		</div>
	</label>
	{#if issueType === '1'}
		<label for="leaveType" class="flex justify-start items-center w-full">
			...
			<div class="flex flex-col">
				...
				<AlertText alerts={$page.form} field="leaveType" />
			</div>
		</label>
		<label for="period" class="flex justify-start items-center w-full">
			...
			<div class="flex flex-col">
				...
				<AlertText alerts={$page.form} field="period" />
			</div>
		</label>
	{:else if issueType === '2'}
		<label class="flex justify-start items-center w-full">
			<span class="w-16">Type</span>
			<select bind:value={paymentType} class="select w-64 rounded-md p-2">
