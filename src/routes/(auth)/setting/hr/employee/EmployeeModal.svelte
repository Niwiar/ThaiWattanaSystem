<script lang="ts">
	...
	import ImageInput from '$component/base/ImageInput.svelte';
	import PdfInput from '$src/lib/components/base/PdfInput.svelte';
...
<ModalFormBase {parent}>
	...
	/>
	<PdfInput
		data={formData.jobApplicationFile ? EMPLOYEE_LOCATION + formData.jobApplicationFile : ''}
		label="ใบสมัครงาน"
